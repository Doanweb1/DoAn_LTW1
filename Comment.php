        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                ...
                <?php 
                    ...
                    $stmt->execute(array($GLOBALS['IDItem']));
                    ...
                    for($i = 0; $i < sizeof($data); $i++)
                    {
                        ...
                        $stmt1->execute(array( $_COOKIE['IDCustomer']));
                        ...
                        <div class="card p-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="user d-flex flex-row align-items-center">
                                    <img src="./SRC-Img/Avatar.jpg" width="80" class="user-img rounded-circle mr-2">
                                    <span>
                    ...
                    <div class="panel-body">
                      ...
                      echo '
                        <form class="form-inline" method = "POST" action = "InformationDetail.php">
                            ...
                            <button name = "btn-comment" class="btn btn-primary pull-right" type="submit" value = "'. $GLOBALS['IDItem'] .'">Share</button>
